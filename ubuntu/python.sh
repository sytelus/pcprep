...
if [ -z "$WSL_DISTRO_NAME" ]; then
    ...
    pip install -q gpustat mpld3 gputil
...
pip install -q  nltk gensim annoy ujson tables sharedmem sacred pprofile mlxtend fitter
pip install -q  sphinx recommonmark sphinx-autobuild sphinx_rtd_theme click-man
pip install -q  azureml-sdk overrides timebudget py-spy autopep8
pip -q install qgrid
