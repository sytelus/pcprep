...
sudo apt-get install libcudnn8=8.9.5.30_1+cuda12.1
sudo apt-get install libcudnn8-dev=8.9.5.30_1+cuda12.1
sudo apt-get install libcudnn8-samples=8.9.5.30_1+cuda12.1
